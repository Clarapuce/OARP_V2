    ...
    public partial class Form1 : Form
    {
        ...
        private void lancer_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if ((NbEleves <= 0) || (NbProjets <= 0) || (NbMax <= 0) || (NbMin <= 0))
                {
                    MessageBox.Show("Tous les renseignements doivent être supérieurs à zéro.");
                }
            ...
            catch { MessageBox.Show("Veuillez renseigner des nombres."); }
        }
        ...
        private void LancerRepartition()
        {
            ...
            MessageBox.Show("La répartition a bien été effectuée en "+dur+"! Vous avez le choix entre " + (i-1) + " solutions différentes.");
        ...
        private void CreerMatrice(int[,] matrice)
        {
            int i = 0;
            int j = 0;
